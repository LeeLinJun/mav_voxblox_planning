#ifndef VOXBLOX_MPC_MPNET_PLANNER_VOXBLOX_MPC_MPNET_PLANNER_H
#define VOXBLOX_MPC_MPNET_PLANNER_VOXBLOX_MPC_MPNET_PLANNER_H
...
class VoxbloxMPCMPNetPlanner {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW

        VoxbloxMPCMPNetPlanner(const ros::NodeHandle& nh,
                               const ros::NodeHandle& nh_private);
        virtual ~VoxbloxMPCMPNetPlanner() {}
...
#endif  // VOXBLOX_MPC_MPNET_PLANNER_VOXBLOX_MPC_MPNET_PLANNER_H

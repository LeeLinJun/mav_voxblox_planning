#ifndef VOXBLOX_SST_PLANNER_VOXBLOX_SST_PLANNER_H
#define VOXBLOX_SST_PLANNER_VOXBLOX_SST_PLANNER_H
...
class VoxbloxSstPlanner {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  VoxbloxSstPlanner(const ros::NodeHandle& nh,
                    const ros::NodeHandle& nh_private);
  virtual ~VoxbloxSstPlanner() {}
